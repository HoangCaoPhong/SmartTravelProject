...
from config import NOMINATIM, OSRM, OPENWEATHER
...
class TestConfig(unittest.TestCase):
    ...
    def test_01_config_urls_not_empty(self):
        ...
        self.assertIsNotNone(NOMINATIM)
        self.assertIsNotNone(OSRM)
        self.assertIsNotNone(OPENWEATHER)
        self.assertTrue(len(NOMINATIM) > 0)
        self.assertTrue(len(OSRM) > 0)
        self.assertTrue(len(OPENWEATHER) > 0)
    
    def test_02_config_urls_valid_format(self):
        """TC02: Kiểm tra format URL hợp lệ (https)"""
        self.assertTrue(NOMINATIM.startswith('https://'))
        self.assertTrue(OSRM.startswith('https://') or OSRM.startswith('http://'))
        self.assertTrue(OPENWEATHER.startswith('https://') or OPENWEATHER.startswith('http://'))
...
class TestGeocoding(unittest.TestCase):
    ...
    def test_04_geocode_empty_result(self, mock_sleep, mock_get):
        ...
        self.assertIn("Không tìm thấy", str(context.exception))
...
class TestRouting(unittest.TestCase):
    ...
    def test_08_get_route_steps_with_instructions(self, mock_get):
        ...
        self.assertEqual(result['steps'][0]['street_name'], 'Main Street')
    ...
    def test_09_get_route_steps_missing_street_name(self, mock_get):
        ...
        self.assertEqual(result['steps'][0]['street_name'], '')
...
class TestMapping(unittest.TestCase):
    ...
    def test_13_create_single_vehicle_map_driving(self):
        ...
        geometry = {'coordinates': [[106.6297, 10.8231], [106.7000, 10.9000]]}
    ...
    def test_15_create_comparison_map(self):
        ...
        geom_car = {'coordinates': [[106.6297, 10.8231], [106.7000, 10.9000]]}
        geom_bike = {'coordinates': [[106.6297, 10.8231], [106.7100, 10.9100]]}
        ...
        self.assertIn('shorter', comparison)
    ...
    def test_16_comparison_car_faster(self):
        ...
        geom = {'coordinates': [[106.6297, 10.8231], [106.7000, 10.9000]]}
        ...
        self.assertEqual(comparison['shorter'], 'car')
    ...
    def test_17_comparison_bike_faster(self):
        ...
        self.assertEqual(comparison['shorter'], 'bike')
